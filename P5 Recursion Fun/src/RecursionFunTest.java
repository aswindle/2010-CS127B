...
public class RecursionFunTest {
	...
	public void testReciprocals(){
		assertEquals(1.0, rf.addReciprocals(1), .000000001);
		assertEquals(1.5, rf.addReciprocals(2), .000000001);
		assertEquals(1.5 + 1/3.0, rf.addReciprocals(3), .000000001);
		assertEquals(1.75 + 1/3.0, rf.addReciprocals(4), .000000001);
	}
	...
	public void testSubSentence(){
		...
		assertEquals("", rf.subsentence("", 3, 3));
	}
	...
	public void testCommas(){
		...
		assertEquals("-1,999", rf.intWithCommas(-1999));
		assertEquals("0", rf.intWithCommas(0));
	}
	...
	public void testArrayRange(){
		...
		assertEquals(3, rf.arrayRange(new int[] { -2, -2, -5, -4 }));
		assertEquals(0, rf.arrayRange(new int[]{}));
	}

	@Test
	public void testBinarySearch(){
		assertEquals(0, rf.binarySearch("A", new String[] {"A", "B", "C", "D", "E", "F"}));
		assertEquals(1, rf.binarySearch("B", new String[] {"A", "B", "C", "D", "E", "F"}));
		assertEquals(2, rf.binarySearch("C", new String[] {"A", "B", "C", "D", "E", "F"}));
		assertEquals(3, rf.binarySearch("D", new String[] {"A", "B", "C", "D", "E", "F"}));
		assertEquals(4, rf.binarySearch("E", new String[] {"A", "B", "C", "D", "E", "F"}));
		assertEquals(5, rf.binarySearch("F", new String[] {"A", "B", "C", "D", "E", "F"}));
		assertEquals(-1, rf.binarySearch("G", new String[] {"A", "B", "C", "D", "E", "F"}));
		assertEquals(-1, rf.binarySearch("A", new String[] {"B", "C", "D", "E", "F"}));
		assertEquals(-1, rf.binarySearch("C", new String[] {"A", "B", "D", "E", "F"}));
		assertEquals(-1, rf.binarySearch("C", new String[] {}));
	}
