...
public class GameTreeSmallTest {
  ...
  // This code executes once and only once before and @Test method runs.  Good for initialization.
  ...
  public void testGameWithSevenNodes() {
    ...
    public void testSaveGame() {
      ...
      // Restore input file to original without the two new questions
      PrintWriter outFile = null;
      try {
        outFile = new PrintWriter(new FileOutputStream("test3.txt"));
      }
      ...
      outFile.println("Is it a mammal?");
      outFile.println("tiger");
      outFile.print("rattlesnake");
  
      outFile.close();
  
      GameTree aGame = new GameTree("test3.txt");
      ...
      aGame.saveGame();
      GameTree anotherGame = new GameTree("test3.txt");
