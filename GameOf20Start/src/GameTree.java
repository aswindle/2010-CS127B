...
public class GameTree {
	...
	public void saveGame() {
		...
		diskFile.println(toStringNoDash());
		diskFile.close();
	}
	...
	private String toStringHelp(TreeNode curr) {
		...
		if (!isQuestion(curr.data))
			return "- " + curr.data;
		else if (curr == root) {
			return "- " + toStringHelp(curr.right) + '\n' + curr.data + '\n'
	...
	private String toStringNoDash() {
		return noDashHelp(root);
	}

	private String noDashHelp(TreeNode curr) {
		if (!isQuestion(curr.data))
			return curr.data;
		else
			return curr.data + '\n' + noDashHelp(curr.left) + '\n'
					+ noDashHelp(curr.right);
	}
}