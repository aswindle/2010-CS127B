/*Alex Swindle
 * C SC 127B Project 2: LinkedPriorityList
 * Tests both LinkedPriorityList and Movie classes
 */
...
public class LinkedPriorityListTest {
	...
	public void testSizeIsEmptyInsertAndGetElement(){
		LinkedPriorityList<String> test1 = new LinkedPriorityList();
		...
		LinkedPriorityList<Integer> test2 = new LinkedPriorityList();
		...
		LinkedPriorityList<String> test3 = new LinkedPriorityList();
		test3.insertElementAt(0, "A");
		assertEquals(1, test3.size());
		test3.insertElementAt(1, "B");
		test3.insertElementAt(0, "C");
		assertEquals("C", test3.getElementAt(0));
		assertEquals("A", test3.getElementAt(1));
		assertEquals("B", test3.getElementAt(2));
	}
	
	@SuppressWarnings("unchecked")
	@Test
	(expected = IllegalArgumentException.class)
	public void testIllegalArgumentsGetElement(){
		LinkedPriorityList<String> illegal = new LinkedPriorityList();
		illegal.getElementAt(25);
	}
	
	@SuppressWarnings("unchecked")
	@Test
	(expected = IllegalArgumentException.class)
	public void testIllegalArgumentsInsert(){
		LinkedPriorityList<String> illegal = new LinkedPriorityList();
		illegal.insertElementAt(5, "blah");
	}
	
	@SuppressWarnings("unchecked")
	@Test
	(expected = IllegalArgumentException.class)
	public void testIllegalArgumentsLower(){
		LinkedPriorityList<String> illegal = new LinkedPriorityList();
		illegal.lowerPriorityOf(3);
	}
	
	@SuppressWarnings("unchecked")
	@Test
	(expected = IllegalArgumentException.class)
	public void testIllegalArgumentsRaise(){
		LinkedPriorityList<String> illegal = new LinkedPriorityList();
		illegal.raisePriorityOf(5);
	}
	
	@SuppressWarnings("unchecked")
	@Test
	(expected = IllegalArgumentException.class)
	public void testIllegalArgumentsMoveLast(){
		LinkedPriorityList<String> illegal = new LinkedPriorityList();
		illegal.moveToLast(5);
	}
	
	@SuppressWarnings("unchecked")
	@Test
	(expected = IllegalArgumentException.class)
	public void testIllegalArgumentsMoveTop(){
		LinkedPriorityList<String> illegal = new LinkedPriorityList();
		illegal.moveToTop(5);
	}
	...
	@Test
	(expected = IllegalArgumentException.class)
	public void testIllegalArgumentsRemove(){
		LinkedPriorityList<String> illegal = new LinkedPriorityList();
		illegal.removeElementAt(5);
	}
	...
	public void testRemoveLowerRaiseTopLastToArray(){
		...
		LinkedPriorityList<String> newTest = new LinkedPriorityList();
		newTest.insertElementAt(0, "Test");
		newTest.removeElementAt(0);
		assertTrue(newTest.isEmpty());
		newTest.insertElementAt(0, "A");
		newTest.insertElementAt(1, "B");
		newTest.insertElementAt(0, "C");
		newTest.removeElementAt(0);
		assertEquals(2, newTest.size());
		assertEquals("A", newTest.getElementAt(0));
		
		LinkedPriorityList<Integer> test3 = new LinkedPriorityList();
		for(int i=0; i<20; i++){
		...
		LinkedPriorityList<String> test4 = new LinkedPriorityList();
		...
		LinkedPriorityList<Integer> test6 = new LinkedPriorityList();
		for(int i=0; i<15; i++){
		...
		LinkedPriorityList<String> test8 = new LinkedPriorityList();
		Object[] test9 = test8.toArray();
		Object[] test10 = new Object[0];
		assertEquals(test10, test9);
		
		LinkedPriorityList<Integer> test11 = new LinkedPriorityList();
		for(int i=0; i<5; i++){
			test11.insertElementAt(i, i);
		}
		assertEquals(5, test11.size());
		test11.moveToLast(0);
		...
		test11.removeElementAt(0);
		assertEquals(new Integer(0), test11.getElementAt(0));
		assertEquals(4, test11.size());
		test11.removeElementAt(3);
		assertEquals(new Integer(4), test11.getElementAt(2));
		assertEquals(3, test11.size());
		test11.removeElementAt(1);
		assertEquals(new Integer(4), test11.getElementAt(1));
