/**
 * This small application uses a model (ArrayPriorityList) that you have implemented
 * and tested. The view, which is a JList with your ArrayPriorityList using your
 * toArray method. 
 * 
 * @author Rick Mercer
 */
...
public class PriorityListGUI extends JFrame {
  ...
  private static ArrayPriorityList<Movie> model;
