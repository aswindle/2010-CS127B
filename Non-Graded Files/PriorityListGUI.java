/**
 * This small application uses a model (LinkedPriorityList) that you have implemented
 * and tested. The view, which is a JList with your LinkedPriorityList using your
 * toArray method. 
 * 
 * @author Rick Mercer
 */
...
public class PriorityListGUI extends JFrame {
  ...
  private static LinkedPriorityList<Movie> model;
    ...
    public void actionPerformed(ActionEvent ae) {
      ...
      do {
        ...
        rating = Integer.parseInt(ratingAsString);
          ...
          JOptionPane
          .showMessageDialog(null, ratingAsString + " is not a valid integer");
        }
